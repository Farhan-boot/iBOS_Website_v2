<?php
	function FS_JESY(){
	  ...
	  //Global Partners
        register_post_type('Global_Partners',array(
            'labels' => array(
                'name' =>'Global Partners',
                'add_new_item' =>'You can Add Your Global Partner Show On Home Page'
                ),
            'public' =>true,
            'supports' =>array('', 'thumbnail', '')
            )); 
     //a-concern-of-akij 
        register_post_type('A_Concern_Of_Akij',array(
            'labels' => array(
                'name' =>'A Concern Of Akij',
                'add_new_item' =>'You can Add Your Concern Of Akij Show On Home Page'
                ),
            'public' =>true,
            'supports' =>array('title', 'thumbnail', 'editor')
          )); 
      //customers-stories
        register_post_type('Customers_Stories',array(
            'labels' => array(
                'name' =>'Customers Stories',
                'add_new_item' =>'You can Add Your Customers Stories Show On Home Page'
                ),
            'public' =>true,
