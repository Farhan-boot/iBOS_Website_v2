  <!-- Product details hero section -->
    <section class="pro-details-hero">
        <div class="container">
            <div class="pro-details-content">
                <div class="details-text">
                    <h2><?php $pages=get_the_title();echo $pages;?></h2>
                    <p>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                    </p>
                    <a class="btn hero-button" href="#">
                        <span>Explore</span>
                    </a>
                </div>
                <div class="details-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/02.png" alt="iBOS">
                </div>
            </div>
        </div>
    </section>

    <!-- Start product BMS section -->
    <section>
        <div class="pro-bms" id="pro-bms">
            <div class="container">
                <h3>Lorem Ipsum is simply dummy text</h3>
                <p>
                    Jump right into the screen design process with InVision Studio's
                    intuitive vector-based drawing capabilities. With flexible layers
                    and an infinite canvas, it’s easy to turn ideas into powerful
                    design.
                </p>
                <div id="slider">
                    <div class="dp-wrap">
                        <div id="dp-slider">
                            <div class="dp_item" data-class="1" data-position="1">
                                <div class="dp-img">
                                    <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/product/06.png" alt="investing" />
                                </div>
                            </div>

                            <div class="dp_item" data-class="2" data-position="2">
                                <div class="dp-img">
                                    <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/product/07.png" alt="investing" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section>
        <div class="pro-details-feature">
            <div class="container">
                <div class="pro-feature-heading position-relative">
                    <div class="heading-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/sme.png" alt="iBOS">
                    </div>
                    <div class="heading-content">
                        <h2>Lorem Ipsum is simply</h2>
                        <p>
                            Jump right into the screen design process with InVision Studio's intuitive vector-based
                            drawing
                            capabilities. With flexible layers and an infinite canvas, it’s easy to turn ideas into
                            powerful
                            design.mJump right into the screen design process with InVision Studio's intuitive
                            vector-based
                            drawing capabilities. With flexible layers and an infinite canvas, it’s easy to turn ideas
                            into
                            powerful design. Jump right into the screen design process with InVision Studio's intuitive
                            vector-based drawing capabilities.
                        </p>
                    </div>
                </div>
                <div class="pro-feature-items special-feature-items">
                    <div class="row">
                        <div class="col-xl-4 col-md-6">
                            <div class="single-item">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/icon/demo.svg" alt="iBOS">
                                </div>
                                <h4>Feature 1</h4>
                                <p>
    ...
    <!-- build for business section -->
    <section>
        <div class="build-for-business">
            <div class="container">
                <div class="first-build">
                    <div class="build-heading">
                        <h2>Build for Business</h2>
                        <p>
                            ump right into the screen design process with InVision Studio's intuitive vector-based
                            drawing capabilities. With
                        </p>
                    </div>
                    <div class="build-content">
                        <div class="build-text">
                            <div class="text-item">
                                <h6>Lorem Ipsum</h6>
                                <p>
                                    ump right into the screen design process with InVision Studio's intuitive
                                    vector-based drawing capabilities. With
                                </p>
                            </div>
                            <div class="text-item">
                                <h6>Lorem Ipsum</h6>
                        ...
                        <div class="build-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/04.png" alt="iBOS">
                        </div>
                    </div>
                </div>
                <div class="secound-build">
                    <div class="build-heading">
                        <h2>Build for Business</h2>
                        <p>
                            ump right into the screen design process with InVision Studio's intuitive vector-based
                    ...
                    <div class="build-content">
                        ...
                        <div class="build-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/05.png" alt="iBOS">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section>
        <div class="pro-special-feature">
            <div class="container">
                ...
                <div class="special-feature-items">
                    <div class="row">
                        <div class="col-xl-4 col-md-6">
                            <div class="single-item">
                                <div class="icon">
    ...
    <section>
        <div class="explore-section">
            <div class="container">
                <div class="explore">
                    <h2>Explore, it’s free, forever</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nec nisi phasellus diam mauris bibendum
                        orci.</p>
                    <a class="btn service-btn" href="#">
                        <span>Get Start, It’s free</span>
    ...
    <section>
        <div class="product-video-section product-client-vedio">
            <div class="container">
                <div class="title-section">
                    <h2 class="section-title">Client video</h2>
                    <p class="section-para">
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy text ever since
                    </p>
                    ...
                    <div class="product-video-section-img">
                        ...
                        <div class="product-video-section-img-overlay">
                            <a class="play-btn mfp-iframe" href="https://www.youtube.com/watch?v=YrEPwYuQW2U">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/play3.png" alt="iBOS">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="partner-section">
            <div class="container">
                <div class="title-section">
                    <h2 class="section-title">Trested by industry leaders</h2>
                    <p class="section-para">
